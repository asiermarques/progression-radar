...
export const queryParamaDataToUrl = (params) => "/?" + URL_PARAM + (params?"="+JSON.stringify(params):"");
...
export const processQueryString = (queryString, validator, roleRepository) => {
    ...
    return Object.assign({}, data, {
        "personLevels": [], 
        "compareToLevels": [],
        "compareTo": data["compareTo"] ? roleRepository.getRoleByKey(data["compareTo"]) : null
    });
}
